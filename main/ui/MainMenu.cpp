...
MainMenu::MainMenu() {
  ...
  root->childs->push_back(new MenuElement(ME_INTEGER,DIC::PLAYR_B1_FREQ_CAP,CM::PLAYR_B1_FREQ,root));
  root->childs->push_back(new MenuElement(ME_INTEGER,DIC::PLAYR_B1_TIME_CAP,CM::PLAYR_B1_TIME,root));
  root->childs->push_back(new MenuElement(ME_INTEGER,DIC::PLAYR_B2_FREQ_CAP,CM::PLAYR_B2_FREQ,root));
  root->childs->push_back(new MenuElement(ME_INTEGER,DIC::PLAYR_B2_TIME_CAP,CM::PLAYR_B2_TIME,root));
}
